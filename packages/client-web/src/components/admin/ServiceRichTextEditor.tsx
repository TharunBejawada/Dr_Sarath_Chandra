...
const ServiceRichTextEditor = ({ value, onChange }: EditorProps) => {
    ...
    input.onchange = async () => {
      if (input.files && input.files[0]) {
        ...
        try {
          ...
          const response = await fetch(`${API_URL}/api/services/uploadServiceImage`, {
            method: "POST",
            body: formData,
          });
...
export default ServiceRichTextEditor;